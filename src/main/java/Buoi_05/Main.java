        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.printf("Tổng giá trị tất cả điện thoại trong cửa hàng là: %fvnd\n", store.calculateTotalPhonePrice());
                    break;
                case 8:
                    double phanTram = Phone.readDouble(sc, "Nhập phần trăm khuyến mãi cho điện thoại cũ:", 0);
